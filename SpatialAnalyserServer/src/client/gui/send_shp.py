...
class Ui_SendSHP(Client):
    def setupUi(self, SendSHP):
        ...
        self.file_info.setGeometry(QtCore.QRect(70, 10, 191, 17))
        self.file_info.setText("")
        self.file_info.setObjectName("file_info")
        self.table_info = QtGui.QLabel(self.frame)
        self.table_info.setGeometry(QtCore.QRect(70, 40, 191, 17))
    ...
    def gui_client_send_shp_to_postgres(self):
        ...
        if self.tabName == '':
            ...
            self.dbParams = self.client_send_shp_to_postgres(self.fName, self.tabName)
            print(self.dbParams.db_ip)
            print(self.dbParams.db_name)
            print(self.dbParams.db_user)
            if self.dbParams.db_ip != '':
                self.status_led.setVisible(True)
                self.ip_info.setText(self.dbParams.db_ip)
                self.host_info.setText(self.dbParams.db_name)
                self.user_info.setText(self.dbParams.db_user)
