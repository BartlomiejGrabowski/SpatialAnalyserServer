...
class Ui_MainWindow(Client):
    ...
    def raster_info1(self):
        ...
        origin = self.client_get_origin('../../../data_files/tif/L71044034_03420050418_B10.TIF')
        print(origin.top_left_x)
        print(origin.top_left_y)
        raster_size = self.client_get_raster_size('../../../data_files/tif/L71044034_03420050418_B10.TIF')
        print(raster_size.x_size)
        print(raster_size.y_size)
        projection = self.client_get_projection_info('../../../data_files/tif/L71044034_03420050418_B10.TIF')
        print(projection)
