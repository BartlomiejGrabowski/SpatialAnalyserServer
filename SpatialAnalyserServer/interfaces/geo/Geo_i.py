...
class Geo_i(Geo__POA.Basic):
    """Geo_i class provides a set of methods to calculating some geo-based parameters using 
    ...
    def distance_haversine(self, lat1, lon1, lat2, lon2):
        ...
        self.logger.log.info("distance_haversine method invocation.")
        
        R = 6371.0
        
        if (lat1 > 90 or lat1 < -90) or (lat2 > 90 or lat2 < -90):
            self.logger.log.error("Latitude exceeds the range (-90 .. 90)")
            raise Geo.LatitudeRangeException("Latitude exceeds the range (-90 .. 90)")
        if (lon1 > 180 or lon1 < -180) or (lon2 > 180 or lon2 < -180):
            self.logger.log.error("Longitude exceeds the range (-180 .. 180)")
            raise Geo.LongitudeRangeException("Longitude exceeds the range (-180 .. 180)")
        ...
        try:
            ...
            raise Geo.InternalException('ERROR: %s\n' % str(ex))
            return 1
    ...
    def distance_sloc(self, lat1, lon1, lat2, lon2):
        """ @brief Compute distance between two points in km using
            ...
            @param {lat2/lon2} float: Destination point.
            @return float Distance between source and destination point. """
        self.logger.log.info("distance_sloc method invocation.")
        R = 6371.0
    ...
    def initial_bearing(self, lat1, lon1, lat2, lon2):
        ...
        self.logger.log.info("initial_bearing method invocation.")
    ...
    def final_bearing(self, lat1, lon1, lat2, lon2):
        ...
        self.logger.log.info("final_bearing method invocation.")
    ...
    def midpoint(self, lat1, lon1, lat2, lon2):
        ...
        self.logger.log.info("midpoint method invocation.")
        ...
        return Geo.Point(round(math.degrees(mLat), 2), round(math.degrees(mLon), 2))
    ...
    def intersection(self, lat1, lon1, brng1, lat2, lon2, brng2):
        ...
        self.logger.log.info("intersection method invocation.")
        ...
        try: 
            ...
            raise Geo.InternalException('ERROR: %s\n' % str(ex))
            return 1 
        return Geo.Point(math.degrees(lat3), math.degrees(lon3))
    ...
    def rhumb_distance(self, lat1, lon1, lat2, lon2):
        ...
        self.logger.log.info("rhumb_distance method invocation.")
    ...
    def rhumb_bearing(self, lat1, lon1, lat2, lon2):
        ...
        self.logger.log.info("rhumb_bearing method invocation.")
    ...
    def rhumb_destination_point(self, lat1, lon1, brng, dist):
        ...
        self.logger.log.info("rhumb_restination_point method invocation.")
        ...
        return Geo.Point(math.degrees(lat2), math.degrees(lon2))
    ...
    def rhumb_midpoint(self, lat1, lon1, lat2, lon2):
        ...
        self.logger.log.info("rhumb_midpoint method invocation.")
    ...
    def destination_point(self, lat1, lon1, brng, dist):
        ...
        self.logger.log.info("destination_point method invocation.")
